...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"API_SERVICE_DEV":"http://192.168.1.2:5001","API_SERVICE":"https://api.unfac.co","LINE_LOGIN_CALLBACK_URL":"http://192.168.1.2:3000/user/authorized","LINE_LOGIN_CHANNEL_ID":"1636599747","LINE_LOGIN_CHANNEL_SECRET":"6d5ffbe193fd5b3ff44954054d0ec594"}
    }
    // Only set once
